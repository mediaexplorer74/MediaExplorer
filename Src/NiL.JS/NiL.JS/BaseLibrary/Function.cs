...
public partial class Function : JSObject, ICallable
{
        ...
        else
        {
            ...
            if (storeValuesInContext)
            {
                ...
                if (!string.IsNullOrEmpty(name)
                    && Kind is FunctionKind.Function or FunctionKind.Generator or FunctionKind.AsyncFunction or FunctionKind.AsyncGenerator)
    ...
    private void setNewKeywordRule()
    {
        RequireNewKeywordLevel = Kind switch
        {
            ...
            or FunctionKind.MethodGenerator
            or FunctionKind.AsyncGenerator => RequireNewKeywordLevel.WithoutNewOnly,
