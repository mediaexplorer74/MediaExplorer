...
/// <remarks>
/// ƒоступ к типу не предоставл€етс€ из скрипта. јтрибуты не нужны
/// </remarks>
...
{
    /// <summary>
    /// Ќа первом проходе будут выбиратьс€ методы со строгим соответствием типов
    ///
    /// Ќа втором проходе будут выбиратьс€ методы, дл€ которых
    /// получитс€ преобразовать входные аргументы.
    ///
    /// Ќа третьем проходе будет выбиратьс€ первый метод,
    /// дл€ которого получитс€ сгенерировать параметры по-умолчанию.
    ///
    /// ≈сли нужен более строгий подбор, то количество проходов нужно
    /// уменьшить до одного
    /// </summary>
