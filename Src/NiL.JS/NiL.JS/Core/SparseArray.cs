...
public sealed class SparseArray<TValue> : IList<TValue>, IDictionary<int, TValue>, ICloneable
{
    ...
    public TValue this[int index]
    {
        ...
        set
        {
            bool isDefault = value is null; // структуры мы будем записывать, иначе пришлось бы вызывать т€желые операции сравнени€.
    ...
    #region „лены ICollection<TValue>
    ...
    #region „лены IEnumerable<TValue>
