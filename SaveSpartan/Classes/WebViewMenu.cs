    ...
    public class WebViewMenu
    {
        ...
        internal class WebViewMenuEvents
        {
            ...
            internal static async void OpenLinkNewTab(WebView Core)
            {
                ...
                WebResources.Navigate("MediaExplorer:Go=" + await coreWView.ActiveElementLink());
            }
            ...
            internal static async void Search(WebView Core)
            {
                ...
                {
                    WebResources.Navigate("MediaExplorer:Go=" + SelectionText);
                }
                else
                {
                    if (SearchEngine == "Bing")
                    {
                        WebResources.Navigate("MediaExplorer:Go=https://www.bing.com/search?q=" + SelectionText);
                    }
                    else if (SearchEngine == "Google")
                    {
                        WebResources.Navigate("MediaExplorer:Go=https://www.google.com/search?q=" + SelectionText);
                    }
                    else if (SearchEngine == "Yahoo")
                    {
                        WebResources.Navigate("MediaExplorer:Go=https://search.yahoo.com/search?p=" + SelectionText);
                    }
                }
            }
        }
